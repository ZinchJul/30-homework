...
from models import Client, Client_Parking, Parking, db
...
def register_routes(app):
    ...
    def client_in_parking():
        ...
        if open_parking.opened:
            if (
                open_parking.count_available_places > 0
                and client.credit_card is not None
            ):
                ...
                take_place_parking = Client_Parking(
                    client_id=client.id,
